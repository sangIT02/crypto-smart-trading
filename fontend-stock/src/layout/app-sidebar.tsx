...
const navItems = [
    { label: 'Tổng quan', href: '/home', icon: Home },
    { label: 'Thị trường', href: '/market', icon: TrendingUp },
    { label: 'Dự đoán AI', href: '/ai-prediction', icon: Zap },
    { label: 'Giao dịch', href: '/trading', icon: Wallet },
    { label: 'Giao dịch lưới', href: '/grid-trading', icon: Grid3X3 },
    { label: 'Bot giao dịch', href: '/bot-trade', icon: Bot },
    { label: 'Danh mục', href: '/portfolio', icon: PieChart },
    { label: 'Trợ lí phân tích', href: '/chat-bot', icon: MessageCircle },
