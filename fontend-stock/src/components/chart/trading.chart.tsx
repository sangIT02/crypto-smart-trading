...
const TradingChart: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleVisibleRangeChange = () => {
      ...
      const threshold =
        oldestTime + 50 * getIntervalSeconds(currentTfRef.current);
  ...
  return (
    ...
    >
      ...
      >
        {/* CHART PANEL */}
        <div
          style={{ flex: "0 0 75%", display: "flex", flexDirection: "column" }}
        >
          {/* HEADER */}
            ...
            >
              ...
              >
                ...
                <span style={{ fontWeight: 700, fontSize: 16, color: "#fff" }}>
                  {selectedCoin.symbol}
                  <span style={{ color: "#5c6478", fontWeight: 400 }}>
                    /USDT
                  </span>
                </span>
                <span
              ...
              {lastPrice && (
                <span
                  style={{ color: "#26a69a", fontWeight: 600, fontSize: 15 }}
                >
